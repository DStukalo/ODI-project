...
export const en: TranslationPackage = {
	...
	DmitroInfo: 'Team coordination and organization of meetings. Backend setup. Implementation of the navigation menu. Routing settings, redax, requests to the server, error handling. 404 page and drag-and-drop implementation',
	IgorTittle: 'Igor Novitski (Developer)',
	IgorInfo: 'Participate in meetings and help other developers. Implementation of the Application\'s Welcome page, Main page, Board page and task cards',
	OlgaTittle: 'Olga Malkovich (Developer)',
	OlgaInfo: 'Participate in meetings and help other developers. Implementing the Application\'s Authorization Page, Profile page, Burger menu and app footer. Adding the validity of forms',
	...
	errorFirstName: 'First name must contain at least 3 letters',
	errorLastName: 'Last name is required',
	errorUsername: 'Login must contain at least 3 letters',
	errorpassword: 'Password must contain at least 6 numbers',
